...
#workspace_dir = r"C:\path\to\your\my_workplace"
#os.chdir(os.path.dirname(vitis_cmd))
...
#from frank_subdir.effect_button import on_menu_item_leave
from frank_subdir.lib import cmd_to_ser, on_menu_item_leave, button_save,SwitchApp, on_menu_enter, on_menu_leave
from frank_subdir.lib import write_button_clicked, read_button_clicked, button_hover,button_leave
#from frank_subdir.effect_button import SwitchApp
#from frank_subdir.effect_button import on_menu_enter, on_menu_leave
#from frank_subdir.effect_button import write_button_clicked, read_button_clicked, button_hover,button_leave
from frank_subdir.layout import RedCircleLabel, change_row_height, change_font_size, update_dc_write_color,  draw_red_circle
from frank_subdir.layout import toggle_scrollbar, show, hide_red_circle
from frank_subdir.lib import mainGUIFrame, debug_print, get_file_content, process_loaded_content
from frank_subdir.lib import get_row_number, write_content_to_file
from frank_subdir.lib import change_bg_color, load_command, load_file,update_label_widgets_bg_color
from frank_subdir.lib import label_widgets_dict, update_label_2nd_var, update_label_trim_var
from frank_subdir.lib import create_win_row, extract_color_from_file_content
from frank_subdir.lib_1 import on_menu_item_hover
...
#    def open_win(win_name, x_position):
    ...
    font_menu.add_command(label="Small", command=lambda: change_font_size(8,win_name))
    font_menu.add_command(label="Medium", command=lambda: change_font_size(10, win_name))
    font_menu.add_command(label="Large", command=lambda: change_font_size(12, win_name))
    # Create a sub-menu for font options
...
def on_menu_click(option):
    ...
    if option == "i2c Ti current":
        ...
        if win_ina228 is None or not win_ina228.winfo_exists():
            win_ina228 = create_subwindow("win_ina228",310,670)
